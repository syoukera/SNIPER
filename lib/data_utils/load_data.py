...
def load_proposal_roidb(dataset_name, image_set_name, root_path, dataset_path, train_val_test_path, result_path=None,
    ...
    imdb = eval(dataset_name)(image_set_name, root_path, dataset_path, train_val_test_path, result_path,load_mask=load_mask)
