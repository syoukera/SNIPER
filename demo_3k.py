...
def main():
    ...
    model_prefix = os.path.join('./output/chips_resnet101_3k/res101_mx_3k/', config.dataset.image_set, 'CRCNN')
    ...
    # load the [index] - [class name] matching fil
    path = os.path.join(config.dataset.dataset_path, 'list_classes.pickle')
